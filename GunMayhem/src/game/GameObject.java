...
//
////we can use an array of game.GameObject object to manage classes more easily.
...
//    }
//
////    public static Enemy findEnemyIntersect(game.GameObject source) {
////        for (int i = 0; i < listObjects.size(); i++) {
////            game.GameObject object = listObjects.get(i);
...
////                return (Enemy) object; //because game.GameObject is the parent class of Enemy, so we can convert.
////            }
////        }
////        return null;
////    }
