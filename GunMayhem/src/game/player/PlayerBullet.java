...
//    public PlayerBullet() {
////        image = SpriteUtils.loadImage("assets/images/game.player-bullets/a/1.png");
//        renderer = new Renderer("assets/images/game.player-bullets/a", 3);
//        position.set(0, 0);
//        velocity.set(0, -5);
...
////        Enemy enemy = game.GameObject.findEnemyIntersect(this);
